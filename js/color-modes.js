...
(() => {
  ...
  const translations = {
    en: {
      ...
      workauth: "EU & US",
      welcome: "About Me",
      p1: "I am a recent data science graduate from The George Washington University. Along with a degree concentration in biotechnology, I have also gained practical experience at organizations of varying scale; from early-stage, seed-round ventures to established research laboratories working to integrate biotechnology with the broader data science lifecycle.",
    ...
    de: {
      ...
      location: "Südholland, Niederlande",
      workauth_literal: "Work Auth:",
      workauth: "EU / US",
      welcome: "Über mich",
